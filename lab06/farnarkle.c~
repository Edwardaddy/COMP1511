...
//
// This program by z5223873) on 26/3
...
int count_arkles(int tiles1[N_TILES], int tiles2[N_TILES]) {
    ...
    int b=0;
    int arkles=0;
    int arkle_array1[N_TILES]={0};
    int arkle_array2[N_TILES]={0};
    while(a<N_TILES){
        if(tiles1[a]==tiles2[a]){
            arkle_array2[a]=arkle_array1[a]=1;
        }
        a++;
    }
    a=0;
    while(a<N_TILES){
        ...
        int c=0;
        while(b < N_TILES){
            if(tiles1[a] == tiles2[b] && arkle_array1[b] == 0 && arkle_array2[a] == 0){
                arkles++;
                arkle_array1[b]=1;
                arkle_array2[a]=1;     
            }
